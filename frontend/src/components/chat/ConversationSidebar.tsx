...
export function ConversationSidebar({
  ...
  // Mode replié : juste la colonne de boutons
  if (isCollapsed) {
    return (
      <div className="flex flex-col items-center gap-2 border-r border-border/40 px-1.5 py-3 shrink-0">
        <Button
          variant="ghost"
          size="icon"
  ...
  return (
    <div className="w-60 sm:w-64 flex flex-col border-r border-border/40 shrink-0 bg-muted/20">
      {/* Header du panneau */}
