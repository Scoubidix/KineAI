...
const { validate, createPatientSchema, updatePatientSchema, updatePatientEmailSchema } = require('../middleware/validate');
...
router.patch('/:id/email', authenticate, crudWriteLimiter, validate(updatePatientEmailSchema), patientsController.updatePatientEmail);
